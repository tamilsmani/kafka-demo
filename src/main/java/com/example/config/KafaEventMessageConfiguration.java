...
@Component
@EnableKafka
public class KafaEventMessageConfiguration  {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(KafaEventMessageConfiguration.class);
	...
	public void listen(@Payload String payload,
		...
		LOGGER.info("Received message topic[{}] and payload[{}]",topic, payload);
		//ack.acknowledge();
	}
	
//	Event Received topic[my-replicated-demo-topic] and 
//	event[ListenerContainerIdleEvent [idleTime=10.013s, listenerId=my-replicated-demo-topic-0, 
//			container=KafkaMessageListenerContainer [id=my-replicated-demo-topic-0, clientIndex=-0, topicPartitions=[my-replicated-demo-topic-0]], 
//			paused=false, topicPartitions=[my-replicated-demo-topic-0]]]
//					
	@EventListener
