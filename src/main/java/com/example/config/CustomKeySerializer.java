...
public class CustomKeySerializer implements Supplier<Serializer<String>> {
	...
	public Serializer<String> get() {
		...
		return new Serializer<String>() {
			...
			public void configure(Map<String, ?> configs, boolean isKey) {
				LOGGER.info("Inside key serializer configure method => [{}] " + configs);
			...
			public byte[] serialize(String topic, String data) {
				if(data != null) {
					LOGGER.info("Inside key serialize method => [{}] " + data);
