...
@Component
@EnableKafka
public class KafaProducerConsumerInterceptorConfiguration  {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(KafaProducerConsumerInterceptorConfiguration.class);
